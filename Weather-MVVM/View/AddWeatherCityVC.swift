...
//                    gotToPage(ViewController.self)
                    
                    
//                    guard let myVC = self?.navigationController?.viewControllers.first(where: { $0 is ViewController }) else { return }
//                      myVC.data = "data"
